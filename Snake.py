...
class Snake:
    def __init__(self,
        ...
        The snake body is represented as a list of positions, starting from
        the head. All segments are placed contiguously and within board bounds.
        ...
        while not valid_placement:
            ...
            for i in range(1, length):
                ...
                if (next_x < 0 or next_x >= board_width or
                        next_y < 0 or next_y >= board_height):
                    valid_placement = False
                    # Try a new direction
                    self.direction = random.choice(directions)
                    break
    ...
    def update_position(self, new_head_position: tuple, action: Action):
        ...
        Args:
            new_head_position: New position for the snake's head as a
                tuple (x, y)
        """
